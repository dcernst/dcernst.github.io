...
<li>If player <em>A</em> names 16, and both players play optimally thereafter, then who wins?</li>
</ul>
</div>
...
<div class="well">
<ul class="list-unstyled">
<li>How many commutation classes does the longest element in the symmetric group have?</li>
</ul>
</div>
...
<div class="well">
<ul class="list-unstyled">
<li>All unicyclic graphs have a prime vertex labeling (Seoud and Youssef, 1999).</li>
<li>All tree graphs have a prime vertex labeling (Entringer-Tout Conjecture, 1980).</li>
</ul>
</div>
