...
<img src="{{ site.baseurl }}/images/2013/12/Q8.png" width=150 align="left" class="img-rounded" img style="margin: 0px 20px"/>The Fall semester of 2013 just ended and one of the classes I taught was [abstract algebra][1]. The course is intended to be an introduction to [groups][2] and [rings][3], although, I spent a lot more time discussing group theory than the latter. A few weeks into the semester, the students were asked to prove the following theorem.
