...
After reading the Nature article, I decided I would procrastinate preparing for the semester to start and see if I could figure out whether I belonged to one of the 24 families. It wasn't obvious to me how I would do this without manually clicking on my advisor ([Richard M. Green](https://math.colorado.edu/~rmg/)), then my advisor's advisor, etc. This was slightly more complicated than I expected because there were quite a few ancestors with 2 advisors, so I had to navigate down multiple paths.   As I clicked around, I drew out my family tree in a notebook.

Here is what I discovered.  My longest branch goes back to Nicolo Fontana Tartaglia and includes Isaac Newton and Galileo Galilei. Interestingly, no one on this path belongs to one of the 24 families mentioned in [The classical origin of modern mathematics](http://epjdatascience.springeropen.com/articles/10.1140/epjds/s13688-016-0088-y).  Also, I was disappointed to find out that I wasn't related to [Leonhard Euler](https://www.genealogy.math.ndsu.nodak.edu/id.php?id=38586). However, I am a descendant of [Henry Bracken](https://www.genealogy.math.ndsu.nodak.edu/id.php?id=129422), who is the head of one of the 24 families.
...
Maybe it is worth mentioning that unless you specify otherwise, the dot and png files will be stored in your home directory.  Here is my mathematical family tree:

<img src="{{ site.baseurl }}/images/FamilyTree.png" class="img-responsive" width="100%" img style="margin-bottom: 10px" />

As you can see, it took a while for my ancestors to leave the University of Cambridge.
