...
- **Homework 6:** Use software (your choice!) to create a flow chart that illustrates the prerequisite structure of all of the undergraduate mathematics courses offered by NAU that have numbers greater than or equal to 123.  For each course, also include the following information: Course number (e.g., MAT 320), Title (e.g., Foundations of Mathematics), and when a course is offered (e.g., every semester, fall only, springs of even years, etc.). (Due Monday, September 26)
