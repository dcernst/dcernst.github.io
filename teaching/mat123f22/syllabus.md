...
<div class="row">
  <div class="col-xs-12 col-sm-6">
    <div>
    <h2>Course Info</h2>
    <strong>Title:</strong> MAT 123: First Year Seminar<br />
    <strong>Semester:</strong> Fall 2022<br />
    <strong>Credits:</strong> 1<br />
    <strong>Section:</strong> Honors<br />
    <strong>Time:</strong> 3:00-3:50PM M<br />
...
- resources and employment opportunities available to department majors;
- some of the research being done by faculty in the Department of Mathematics and Statistics; and
...
Upon successful completion of the course, the student will be able to: 
   1. Design a personal program of study leading to a B.S. degree in a program in the department.
   2. Describe careers available to individuals with a degree in mathematics, mathematics education, data science, or statistics, as well as academic preparation required for various careers.
   3. Use software (e.g. LaTeX) to typeset mathematics.
   4. Describe the faculty of the department and some of their interests.
   5. Make use of the resources and opportunities available to majors in the department.
...
**Flexible Assignments:** These assignments are a sort of "choose your own adventure".  Each Flexible Assignment has a designated point value.  Over the course of the semester, you must complete enough Flexible Assignments to **achieve at least 150 points by Friday, October 21** and **a total of at least 300 points by the end of semester**. See the [Homework]({{site.baseurl}}/teaching/mat123f22/homework/) page for a list of the potential Flexible Assignments.  Feel free to suggest more items for the list.
...
The grading basis for this course is Pass/Fail. You must **complete all of the Required Assignments** and **complete enough Flexible Assignments achieve a total of at least 300 points by the end of semester** (and 150 points by Friday, October 21).   Otherwise, a student will receive a grade of Fail for the course.
