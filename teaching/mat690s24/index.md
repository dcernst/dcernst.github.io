...
## Welcome ##
Welcome to the course web page for the Spring 2024 manifestation of MAT 690: Combinatorial Game Theory at [Northern Arizona University](http://nau.edu).

<div class="row">
  <div class="col-xs-12 col-sm-6">
    <div>
    <h2>Course Info</h2>
    <strong>Title:</strong> MAT 690: Combinatorial Game Theory<br />
    <strong>Semester:</strong> Spring 2024<br />
    <strong>Credits:</strong> 3<br />
    <strong>Section:</strong> 1<br />
    <strong>Time:</strong> 11:30-12:20PM MWF<br />
    <strong>Location:</strong> AMB 206
    </div>
  </div>
...
This course will be an introduction to combinatorial game theory. We will study both impartial and partizan two-player games.
