...
- **Daily Homework 25:** Complete 6.23, 6.24 (either (a) or (b)), 6.27, 6.29, 6.31 in [Chapter 6: Differentiation]({{site.baseurl}}/teaching/mat431s20/Differentiation.pdf). In the interest of time, let's take 6.30 for granted (derivatives give slopes of tangent lines). In addition, write a reflection on the student work for Problems (posted on Saturday evening) that is posted under "Student Work" in BbLearn. Submit a digital copy (PDF) of your work in BbLearn. (Due by 5pm on Monday, March 30)
