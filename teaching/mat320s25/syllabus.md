...
<i class="far fa-hand-peace"></i>&nbsp; This page is under construction and subject to change!
</div> -->
...
### Best Practices as a Student in MAT 320 ### 
Ultimately, each student is responsible for making the best choices when it comes to their learning. However, if you want to optimize your experience, here are some suggestions for best practices:
  ...
  - Some comments about taking notes in this class:
      - During class I will usually be displaying the textbook via the LCD projector. The book mostly consists of problem/theorem statements, but the solutions/proofs are missing!
