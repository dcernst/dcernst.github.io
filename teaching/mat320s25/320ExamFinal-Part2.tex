...
\item (4 points each) Prove \fbox{\textbf{two}} of the true statements in Problem 8.89(a)--(j).
\item (2 points each) Provide a counterexample for \fbox{\textbf{two}} of the false statements in Problem 8.89(a)--(j).
