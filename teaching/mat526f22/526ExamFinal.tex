...
\item A \emph{standard Young tableau} is a two dimensional array of numbers (from 1 to the number of entries in the array) that increases across rows and down columns. Let $\SYT(2, n)$ denote the number of standard Young tableaux in a $2\times n$ rectangular array. Enumerate $|\SYT(2,n)|$.
