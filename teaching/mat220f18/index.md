...
## Welcome ##
Welcome to the course web page for the Fall 2018 manifestation of MAT 220: Introduction to Mathematical Reasoning at [Northern Arizona University](http://nau.edu).
...
As the semester progresses, it should become clear to you what the expectations are.  This will be new to many of you and there may be some growing pains associated with it. For more details, see the [syllabus]({{ site.baseurl }}/teaching/mat220f18/syllabus/).
