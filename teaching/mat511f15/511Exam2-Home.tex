...
\item Suppose that $G$ is a finite group having exactly $n$ Sylow $p$-subgroups. Prove that there exists a homomorphic image $H$ of $G$ in $S_n$ having exactly $n$ Sylow $p$-subgroups.
