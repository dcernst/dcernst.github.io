...
<ul class="fa-ul">
  <li><i class="fa fa-calendar-check-o"></i>&nbsp; <b>Monday, August 31:</b> First day!  We spent the majority of the time doing the <a href="{{ site.baseurl }}/teaching/SettingTheStage.pdf">Setting the Stage</a> activity, which generated lots of great discussion.  The last 10-15 minutes of class were spent discussing the <a href="{{ site.baseurl }}/teaching/mat136f15/syllabus.pdf">syllabus</a> and surfing the course webpage.</li>
  <li><i class="fa fa-calendar-check-o"></i>&nbsp; <b>Wednesday, September 2:</b> Coming soon.</li>
  <li><i class="fa fa-calendar-check-o"></i>&nbsp; <b>Thursday, September 3:</b> Coming soon.</li>
  <li><i class="fa fa-calendar-check-o"></i>&nbsp; <b>Friday, September 4:</b> Coming soon.</li>
</ul>
