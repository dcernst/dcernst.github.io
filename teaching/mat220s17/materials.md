...
<ul class="fa-ul">
  <li><i class="fa-li fa-file-pdf-o fa-fw"></i>&nbsp; <a href="{{ site.baseurl }}/teaching/SettingTheStage.pdf">Setting the Stage</a></li>
  <li><i class="fa-li fa-file-pdf-o fa-fw"></i>&nbsp; <a href="{{ site.baseurl }}/teaching/ElementsOfStyle.pdf">Elements of Style for Proofs</a></li>
  <li><i class="fa-li fa-file-pdf-o fa-fw"></i>&nbsp; <a href="{{ site.baseurl }}/teaching/220ProblemCollection.pdf">Problem Collection for Mathematical Reasoning</a></li>
</ul>
