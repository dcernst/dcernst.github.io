...
<ul class="fa-ul">
  ...
  <li><i class="fa-li fa fa-calendar-check-o"></i><b>Wednesday, November 8:</b> Even though we didn't accomplish everything we set out to do today, we got a lot done.  We spent over half the class period reviewing the key ideas of Problems 65 and 68.  I left a few of the details for Problem 68 to the students to take care of for homework.  With the time we had left, we heard from DO, KS, and MG about Problem 72.  We didn't have time to discuss Problem 72, so we will have to squeeze that one in next time.</li>
