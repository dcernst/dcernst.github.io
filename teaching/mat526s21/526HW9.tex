...
%Given a lattice path $p$ consisting only of north and east steps, define $\area(p)$ to be the total area under the path $p$ (and above the $x$-axis). Recall the definition of $L(k,n-k)$ that appeared on Part 2 of Exam 1. Prove that
%\[
...
\item \emph{Saved for next homework.}
%Find an explicit bijection between triangulations of a convex $(n+2)$-gon and $PB(n)$.
\end{enumerate}
\end{document}