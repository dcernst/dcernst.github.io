...
- **Daily Homework 33:** Define a *shuffle* of two words $u=u(1)u(2)\cdots u(k)$ and $v=v(1)v(2)\cdots v(l)$ to be the word containing the letters of $u$ and $v$ such that $u$ and $v$ appear as subwords in the proper order, and denote the set of shuffles of $u$ and $v$ by $u\shuffle v$. (Due Wednesday, May 1)
