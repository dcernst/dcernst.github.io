...
## Welcome ##
Welcome to the course web page for the Spring 2019 manifestation of MAT 526: Topics in Combinatorics at [Northern Arizona University](http://nau.edu).
...
As the semester progresses, it should become clear to you what the expectations are.  For more details, see the [syllabus]({{ site.baseurl }}/teaching/mat526s19/syllabus/).
