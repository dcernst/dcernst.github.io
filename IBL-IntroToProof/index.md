...
- [PDF of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IBLIntroToProof-current.pdf) (Updated May 2, 2023)
- [Print version available via AMS/MAA Press](https://bookstore.ams.org/text-73/)
- [Instructor Manual]({{ site.baseurl }}/IBL-IntroToProof/InstructorGuide.pdf) (Draft: Updated May 2, 2023; Chapters 8 and 9 coming soon!)
- [Errata]({{ site.baseurl }}/IBL-IntroToProof/Errata.pdf) (Updated May 2, 2023)
