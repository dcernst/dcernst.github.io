...
- [PDF of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IBLIntroToProof-current.pdf) (Updated August 2, 2023)
- [PreTeXt version of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/pretext/frontmatter-1.html) (*Draft!* Updated August 2, 2023)
