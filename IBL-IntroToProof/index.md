...
- [PDF of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IBLIntroToProof-current.pdf) (Updated September 22, 2023)
- [PreTeXt/HMTL version of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/pretext/index.html) (*Draft!* Updated September 9, 2023)
...
- [Errata]({{ site.baseurl }}/IBL-IntroToProof/Errata.pdf) (Updated September 22, 2023)
