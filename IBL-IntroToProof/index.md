...
- [PDF of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IntroToProof.pdf) (Updated November 7, 2025)
- [HMTL version of textbook compiled from the current source](https://danaernst.com/IntroToProofViaIBL/) (Updated November 7, 2025)
