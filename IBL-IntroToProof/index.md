...
- [Version of textbook that matches the current print version]({{ site.baseurl }}/IBL-IntroToProof/IBLIntroToProof-AMSSpring2022.pdf) (PDF)
- [Version of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IBLIntroToProof-current.pdf) (PDF)
