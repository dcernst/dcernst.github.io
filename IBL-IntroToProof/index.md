...
- [PDF of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IBLIntroToProof-current.pdf) (Updated August 20, 2022)
- [Print version available via AMS/MAA Press](https://bookstore.ams.org/text-73/)
- [(Draft) Instructor Manual]({{ site.baseurl }}/IBL-IntroToProof/InstructorGuide.pdf) (Updated February 23, 2023; Chapters 8 and 9 coming soon!)
- [Errata]({{ site.baseurl }}/IBL-IntroToProof/Errata.pdf) (Updated August 20, 2022)
...
- [Paul Ellis](http://www.paulellis.org) (Manhattanville College). Paul has provided lots of useful feedback and several suggestions for improvements. Paul suggested problems for Chapter 4 and provided an initial draft of Section 8.4: Images and Preimages of Functions.
