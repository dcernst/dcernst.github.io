...
- [PDF of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/IntroToProof.pdf) (Updated October 29, 2023)
- [PreTeXt/HMTL version of textbook compiled from the current source]({{ site.baseurl }}/IBL-IntroToProof/pretext/index.html) (*Draft!* Updated October 29, 2023)
...
- [Errata]({{ site.baseurl }}/IBL-IntroToProof/Errata.pdf) (Updated October 29, 2023)
